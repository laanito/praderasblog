...
| `praderas-day-18-cover-image-hero-social-responsive` | `reviviendo-praderas-dia-18-imagen-hero-og-responsive.md` | `reviving-praderas-day-18-cover-hero-og-responsive.md` | done | Day 18: `Image:` hero + `og:image` + responsive CSS; picsum removed from listings; `frontmatter_audit` EN tree + path check; **dedicated** `day18-comfyui-sdxl-cover-responsive.png` + `export_cover.py`; image migration plan in `.agents`. |
...
- **2026-05-11:** Day 18 ES/EN log (`praderas-day-18-cover-image-hero-social-responsive`) — `Image:` + social meta + listing placeholders; ComfyUI generation marked production-ready in `.agents/comfyui-cover-images.md`; Day 17 posts gain `Image:` + copy edits.
