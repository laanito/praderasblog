---
Title: The evolution of artificial intelligence and video games
Description: How games and AI grew up together—from chess programs to modern training sandboxes—and where the relationship may go next.
Author: Luis Amigo
...
As [ExpressVPN’s overview](https://www.expressvpn.com/blog/why-games-are-ideal-for-training-ai/) notes (English site), integration of AI into games moved from shallow scripted behaviors toward adaptive, sometimes learning-based opponents.
...
[Universe](https://openai.com/research/universe) aimed to let agents interact with diverse PC games through pixels and controls—one toolkit spanning genres from strategy to platformers, supporting shared RL recipes.
...
The partnership is nowhere near finished—as we already discussed [in this article](/blog/en/impact-of-ai-on-entertainment). Forward-looking scenarios include:
