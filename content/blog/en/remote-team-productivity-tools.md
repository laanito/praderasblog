...
Description: A survey of common communication, project-management, note-taking, video, and automation tools used in distributed teams—from Slack and Zoom to Zapier and focus aids.
Author: Luis Amigo
...
If you prefer **self-hosted** free software on Linux, pair this article with **[Libre Linux and VM productivity tools](%base_url%/blog/en/libre-linux-vm-productivity-tools)** for a complementary reading list.
