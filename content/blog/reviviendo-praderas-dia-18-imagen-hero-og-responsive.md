---
Title: Reviviendo Praderas (Día 18) — `Image:` en portada, Open Graph y formato responsive (Picsum si no hay imagen)
Description: Implementación de hero opcional desde front matter, metadatos sociales, tarjetas de listado con miniatura desde `Image:` o Picsum estable, CSS para imágenes en cuerpo y hero; ComfyUI listo para producción en generación; bitácora con reloj de pared.
