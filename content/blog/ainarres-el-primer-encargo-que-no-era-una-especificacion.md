...
Description: Todas las peticiones que le había dado al enjambre eran especificaciones disfrazadas — la función nombrada, las cadenas entre comillas, las aserciones enumeradas. Esta era un problema, un contrato que no podía reabrir y permiso para negarse. Volvió como un grafo de dependencias de cuatro nodos y cuatro pull requests fusionadas en setenta y un minutos. Luego la medición me dijo que el arreglo que publiqué la semana pasada había resuelto el caso y se había perdido la clase, y el operador señaló que la funcionalidad que elimina la latencia no estaba corriendo en la máquina que acababa de construirla.
...
No voy a fingir que esto es elegante. La semana pasada elegí entre tres opciones y cogí la barata que encajaba con la evidencia que tenía. La evidencia que tenía venía de una ejecución en la que cada barrido tocaba una tarea, porque yo había escrito los encargos lo bastante pequeños para que siempre fuera así. **Un encargo con forma de problema produce barridos más grandes, y los barridos más grandes rompen la suposición sobre la que se construyó mi arreglo.** La respuesta correcta era la opción cara que me salté: reportar el gasto por transición, no por barrido. Es ya la cosa más vieja de la lista que sé hacer y no he hecho.
...
Y luego produjo los dos hallazgos que yo no podría haber generado solo, y los dos son sobre *mi* trabajo y no sobre el de la máquina. Mi métrica de gasto se construyó sobre una suposición que mis propias costumbres al escribir encargos venían imponiendo en silencio. Mi decisión de dejar sin construir el ciclo de vida del servicio era correcta para la pregunta que hice y equivocada para la pregunta que debería haber hecho.
