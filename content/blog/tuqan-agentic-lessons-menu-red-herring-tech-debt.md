...
**Related reading**
- [Tuqan — Lecciones (5): modernizando las dependencias del composer](https://praderas.org/blog/tuqan-agentic-lessons-composer-deps-modernization)
- Plan de migración y evidencia en `.agents/` del repo de Tuqan
